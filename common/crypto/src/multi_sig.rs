...
mod tests {
    ...
    fn test_secp256k1_verification() {
        ...
        let result = verifier.verify(SignatureScheme::Secp256k1, &pk_bytes, message, &signature);
    ...
    fn test_invalid_signature_length() {
        ...
        let result = verifier.verify(SignatureScheme::Secp256k1, &pk_bytes, message, &invalid_sig);
    ...
    fn test_auto_detect_scheme() {
        ...
        assert_eq!(
            verifier.auto_detect_scheme(&sig_64),
