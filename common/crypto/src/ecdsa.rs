use secp256k1::{Secp256k1, SecretKey, PublicKey, Message, All, Error as Secp256k1Error};
...
mod tests {
    ...
    fn test_secret_key_serialization() {
        ...
        // Should be equal
        assert_eq!(crypto.secret_key_to_bytes(&sk), crypto.secret_key_to_bytes(&sk2));
    }
    ...
    fn test_public_key_serialization() {
        ...
        // Should be equal
        assert_eq!(crypto.public_key_to_bytes(&pk), crypto.public_key_to_bytes(&pk2));
    }
}
