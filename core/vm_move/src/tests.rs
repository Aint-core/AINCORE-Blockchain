...
mod tests {
    ...
    /// #35: AINCORE addresses are widened to 32 bytes via the move-core-types
    /// `address32` feature. This guards against the feature silently regressing
    /// back to the 16-byte default, which would corrupt every BCS-serialized
    /// address and break the chain.
    #[test]
